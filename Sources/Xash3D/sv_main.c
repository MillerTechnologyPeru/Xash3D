...
convar_t	*xash_timeout;				// seconds without any message
...
void SV_CheckTimeouts( void )
{
	...
	droppoint = host.realtime - xash_timeout->value;
...
void SV_Init( void )
{
	...
	xash_timeout = Cvar_Get( "timeout", "125", FCVAR_SERVER, "connection timeout" );
